...
- **Algoritmo Estendido de Euclides**: Encontra x, y tal que a*x + b*y = mdc(a,b)
...
# MDC
mdc = CryptoMath.mdc(48, 18)  # Resultado: 6
...
inv = CryptoMath.inverso_modular(3, 11)  # Resultado: 4
# Verificação: (3 * 4) % 11 = 1

# Exponenciação Modular
result = CryptoMath.exponenciacao_modular(2, 10, 1000)  # Resultado: 24

# Teste de Primalidade
eh_primo = CryptoMath.eh_primo(17)  # Resultado: True

# Função φ de Euler
phi = CryptoMath.totiente_euler(12)  # Resultado: 4
phi_pq = CryptoMath.totiente_euler_pq(5, 7)  # Resultado: 24
...
coprime = CryptoMath.sao_coprimos(15, 28)  # Resultado: True
...
2. **Módulos devem ser coprimos**: No Teorema Chinês do Resto, verifique mdc
